...
| #4288 | Provenance-aware customization doctor | OPEN (upd 09:44Z) | PR #4350 OPEN, MERGEABLE / mergeState **CLEAN**, head `15a73c5f4d`, branch ahead=3 behind=4; all checks SUCCESS incl. check:`@gajae-code/coding-agent` | no merge yet | **Nonterminal** (review-ready) |
...
#4283 stays **OPEN**. Terminal: 3/7 (#4286, #4287, #4285 — closed with evidence this run). Nonterminal: #4284 (one PR-owned lint fix, diagnosis delivered to lane), #4288 (review-ready PR #4350 CLEAN), #4291 + #4292 (no pushed branch, no PR — lanes owe pushed evidence; coordination comments posted).
