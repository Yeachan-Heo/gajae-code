...
| [28](28-fabricated-quality-gate-hardening.md) | FIX + honest residual | Fabricated completion gates: protected-gate verifier backing and cross-goal reuse refusal were already enforced; placeholder command strings are now refused with a red→green receipt. What remains asserted rather than verified for ordinary goals is stated plainly. |
