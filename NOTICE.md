...
- [`oh-my-pi`](https://github.com/can1357/oh-my-pi) — the upstream red-claw lineage and implementation DNA; `crates/pi-natives/src/text.rs` and `keys.rs` include MIT-licensed code re-synced from commit `a85bd5228d9f0f619deade1db78fa49420a721e1`.
