...
// src/output_decode.rs — MIT (c) 2025 Mario Zechner, 2025-2026 Can Bölük, 2026
// Stencil Labs, Inc. Modified for gajae-code: yes, integrated with shell output
// budgets and buffered minimizer captures.
