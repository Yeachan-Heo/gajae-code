...
mod platform {
	...
	// libc 0.2.186 unified the BSD/Apple `st_mtimespec` timespec field into
	// flat `st_mtime` + nanosecond fields; only NetBSD spells the nanosecond
	// field without an underscore.
