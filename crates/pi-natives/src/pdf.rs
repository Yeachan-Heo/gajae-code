// Vendored from oh-my-pi (MIT) crates/pi-natives/src/pdf.rs @
// a85bd5228d9f0f619deade1db78fa49420a721e1 Modified for gajae-code: yes — local
// attribution and module export wiring only.
