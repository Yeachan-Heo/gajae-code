// Vendored from oh-my-pi (MIT) crates/pi-natives/src/clipboard.rs @
// a85bd5228d9f0f619deade1db78fa49420a721e1 Local modifications: use
// `crate::js::into_string`, tag synchronous text copy, and read DIB pixels from
// a golden fixture.
...
pub fn copy_to_clipboard(text: JsString) -> Result<()> {
	...
	set_clipboard_text(&js::into_string(text)?)
}
