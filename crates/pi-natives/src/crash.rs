// Vendored from oh-my-pi (MIT) crates/pi-natives/src/crash_handler.rs @ a85bd5228d9f0f619deade1db78fa49420a721e1
// Local modifications: preserve GJC opt-in panic diagnostics and report alloc failures only under the same environment gate.
...
/// Installs Rust panic and allocation-error hooks only when `GJC_NATIVE_CRASH_DIAGNOSTICS` is set.
///
