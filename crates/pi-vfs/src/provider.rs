// Vendored from oh-my-pi (MIT) crates/pi-vfs/src/provider.rs @ a85bd5228d9f0f619deade1db78fa49420a721e1
...
// async_trait expands async methods to #[must_use] pinned futures, which newer clippy reports as
// double_must_use on generated code.
