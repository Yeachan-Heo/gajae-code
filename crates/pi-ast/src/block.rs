// Vendored from oh-my-pi (MIT) crates/pi-ast/src/block.rs @
// a85bd5228d9f0f619deade1db78fa49420a721e1 Local modifications: gate optional
// Swift and Emacs Lisp tests on full-langs.
