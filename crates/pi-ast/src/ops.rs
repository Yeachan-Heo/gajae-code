...
mod tests {
	...
	#[test]
	fn compile_search_patterns_wraps_json_object_pairs() {
		let patterns = compile_search_patterns(r#""key": $VALUE"#, SupportLang::Json)
			.expect("multi-node JSON pairs should compile inside an object");
