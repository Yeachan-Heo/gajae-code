...
It is not a bundled workflow skill. Gajae-Code's public workflow surface comprises `deep-interview`, `ralplan`, `ultragoal`, `team`, and `ultratest`; use this document as planning/review guidance inside those workflows or direct implementation.
