...
- `claude-opus` — Anthropic OAuth preset that prefers `claude-opus-5-5` at medium default/planner effort and high critic/architect effort, with deterministic fallback to `claude-opus-4-6`
