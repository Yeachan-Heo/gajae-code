...
| `CMUX_WORKSPACE_ID`            | cmux-provided workspace identifier. A valid identifier is required before optional cmux browser/agent-surface presentation can activate; GJC verifies the local cmux CLI separately. |
