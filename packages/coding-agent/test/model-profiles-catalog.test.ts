...
const expectedProfiles: Array<{
	...
	},
	{
		...
		mapping: {
			...
			executor: "zai/glm-5.3:minimal",
			planner: "zai/glm-5.3:low",
			critic: "zai/glm-5.3:medium",
	...
	},
	{
		...
		requiredProviders: ["zai"],
		mapping: {
			default: "zai/glm-5.3:medium",
			executor: "zai/glm-5.3:low",
			planner: "zai/glm-5.3:medium",
			critic: "zai/glm-5.3:high",
			architect: "zai/glm-5.3:xhigh",
		},
	},
	{
		name: "glm-pro",
		requiredProviders: ["zai"],
		mapping: {
			default: "zai/glm-5.3:xhigh",
			executor: "zai/glm-5.3:medium",
			planner: "zai/glm-5.3:high",
			critic: "zai/glm-5.3:xhigh",
			architect: "zai/glm-5.3:xhigh",
		},
	},
	{
