...
describe("CLI help load order", () => {
	...
	it("lists representative commands in root --help", async () => {
		...
		expect(stdout).toContain("gjc acp");
		...
		expect(stdout).toContain("gjc contribution-prep");
		expect(stdout).toContain("gjc codex-native-hook");
		expect(stdout).toContain("gjc gc");
		expect(stdout).toContain("gjc completion");
		expect(stdout).toContain("gjc local-provider");
		expect(stdout).toContain("gjc <command> --help");
		expect(stdout).toContain("Available Tools");
		expect(stdout).toContain("search");
		expect(stdout).toContain("search_tool_bm25");
		expect(stdout).not.toContain("  grep");
		expect(stdout).not.toContain("  python");
		expect(stdout).not.toContain("  notebook");
		expect(stdout).not.toContain("--extension");
		expect(stdout).not.toContain("--no-extensions");
		expect(stdout).not.toContain("--no-skills");
