...
test("ACP CWD matching requires fully-qualified absolute paths in each path flavor", () => {
	const cases: Array<{
		...
		{ flavor: "posix", locator: "/Workspace", cwd: "/workspace", matches: false },
		{ flavor: "posix", locator: "//server/share", cwd: "/server/share", matches: false },
		{ flavor: "posix", locator: "//server/share/.", cwd: "//server/share", matches: true },
		...
		{
			flavor: "win32",
			locator: String.raw`\\?\C:\workspace`,
