...
describe("telegram daemon /btw reservation and capability boundaries", () => {
	...
	test.each([
		...
		[
			"same settled text with a non-400 error remains retryable",
		...
		[
			"same settled text with 401 remains retryable",
		...
		[
			"same settled text with 403 remains retryable",
		...
		[
			"same settled text with 429 remains retryable",
