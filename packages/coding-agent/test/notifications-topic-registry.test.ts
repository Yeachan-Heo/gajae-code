...
test("publishes exact durable authority generation 157 at serving epoch 87", () => {
	...
	// Generation 157: terminal-abort notification admission and cleanup semantics.
	expect(DAEMON_GENERATION).toBe(157);
