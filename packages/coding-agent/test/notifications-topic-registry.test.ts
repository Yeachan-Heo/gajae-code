...
test("publishes exact durable authority generation 164 at serving epoch 87", () => {
	...
	// Generation 163: detached notification ownership cleanup on current dev.
	// Generation 164: autorouting changes the notification extension lifecycle.
	expect(DAEMON_GENERATION).toBe(164);
