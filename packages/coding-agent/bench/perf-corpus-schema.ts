...
export const V1_V3_RECLASSIFICATION: readonly HotspotClassification[] = [
	...
	{ hotspotId: "H10", status: "needs-trace-coverage", evidenceClass: "wall-clock-proxy", artifactRefs: [], notes: "xxHash64-accelerated session equality (v3); microbench-only; absent from the agent-session-lifecycle profile (#5942)" },
	...
	{ hotspotId: "M01", status: "covered-current", evidenceClass: "rss-memory", artifactRefs: [], notes: "EphemeralBlobStore externalization (v3); agent-session-profile (#5942): 1-3% self / ~30% inclusive, not self-time confirmed; fixture resets its session every 128 sub-1KiB entries, so long-lived retention is not exercised" },
	{ hotspotId: "M02", status: "covered-current", evidenceClass: "rss-memory", artifactRefs: [], notes: "revision-keyed WeakRef materialization cache (v3); agent-session-profile (#5942): 0% self / ~47% inclusive, cost sits in callee Object.entries walks; not self-time confirmed" },
	{ hotspotId: "M03", status: "needs-trace-coverage", evidenceClass: "rss-memory", artifactRefs: [], notes: "WeakRef buildSessionContext cache (v3); absent from the agent-session-lifecycle profile (#5942)" },
	{ hotspotId: "M04", status: "needs-trace-coverage", evidenceClass: "rss-memory", artifactRefs: [], notes: "fingerprint caching + JSON-semantic clone (v2/v3); absent from the agent-session-lifecycle profile (#5942)" },
	{ hotspotId: "M05", status: "needs-trace-coverage", evidenceClass: "rss-memory", artifactRefs: [], notes: "revision-bumped capture/restore (v3); absent from the agent-session-lifecycle profile (#5942)" },
];
