...
export const V1_V3_RECLASSIFICATION: readonly HotspotClassification[] = [
	...
	{ hotspotId: "M01", status: "covered-current", evidenceClass: "rss-memory", artifactRefs: [], notes: "EphemeralBlobStore externalization (v3); agent-session-profile (#5942): reachable heap bounded, RSS growth is allocator high-water; CPU-self-time confirmed only with that tool's profiler artifact" },
	{ hotspotId: "M02", status: "covered-current", evidenceClass: "rss-memory", artifactRefs: [], notes: "revision-keyed WeakRef materialization cache (v3); agent-session-profile (#5942): reachable heap bounded, CPU-self-time confirmed only with that tool's profiler artifact" },
