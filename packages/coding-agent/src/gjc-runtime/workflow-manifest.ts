	...
	"deep-interview": manifest({
		...
		typedArgs: [
			...
			},
			{
				name: "round-key",
				type: "string",
				appliesToVerbs: ["draft create", "prepare-and-apply-round-result"],
			},
			...
			},
			{
				...
				appliesToVerbs: ["draft edit", "prepare-and-apply-round-result"],
			},
			{
				name: "path",
				type: "string",
			...
			{ name: "value", type: "string", appliesToVerbs: ["draft edit", "prepare-and-apply-round-result"] },
			{
				name: "value-file",
				type: "string",
				appliesToVerbs: ["draft edit", "prepare-and-apply-round-result"],
			},
			{ name: "null", type: "boolean", appliesToVerbs: ["draft edit", "prepare-and-apply-round-result"] },
			...
			},
			{
				...
				type: "string",
				required: true,
				appliesToVerbs: ["inspect", "sanity-check", "prepare-and-apply-round-result"],
			},
			{
				name: "session-id",
				type: "string",
