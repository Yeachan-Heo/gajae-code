...
// tmux copy-mode pads lines to the pane width, so require at least two spaces
// after the standalone `user` label instead of using a brittle end-of-line anchor.
