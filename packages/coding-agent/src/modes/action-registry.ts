...
export const APP_ACTION_METADATA: readonly ActionMetadata[] = [
	...
	action("app.transcript.pageUp", "Page transcript up", "Transcript", ["composer"]),
	action("app.transcript.pageDown", "Page transcript down", "Transcript", ["composer"]),
	action("app.transcript.tail", "Return transcript to tail", "Transcript", ["composer"]),
