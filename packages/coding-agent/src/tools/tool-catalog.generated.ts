...
export const TOOL_CATALOG: Readonly<Record<string, ToolCatalogEntry>> = {
	...
	"skill_discovery": {
		...
		"deferrable": false,
		"loadMode": "essential",
		"summary": "Discover bundled GJC workflow, project, and user runtime skills by thin metadata"
	},
	"telegram_send": {
		"name": "telegram_send",
		"label": "TelegramSend",
