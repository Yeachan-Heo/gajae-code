...
export const TOOL_CATALOG: Readonly<Record<string, ToolCatalogEntry>> = {
				...
				"tasks": {
					...
					"items": {
						...
						"properties": {
							...
							"repositoryBinding": {
								"description": "authoritative repository identity; omitted items are stamped from session cwd before discovery/spawn and still fail closed on sibling drift. A declared binding must match the active session; use a new session rooted in the approved worktree (for example, gjc --cwd <approved-worktree>) for another repository.",
								"type": "object",
								"properties": {
									"schema": {
										"type": "string",
	...
	"subagent": {
		...
		"parameters": {
			...
			"properties": {
				...
				"heartbeat_ms": {
					"description": "heartbeat interval in milliseconds (100-60000); 0 disables",
					"type": "number"
				},
				"timeout_ms": {
	...
	"skill_discovery": {
		...
		"parameters": {
			...
			"properties": {
				"query": {
					"description": "words to match against skill name, description, source, or use conditions; every term must appear (conjunctive substring), or one term must equal the exact skill name",
					"type": "string"
				},
				"source": {
