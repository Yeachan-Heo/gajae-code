...
- **Do NOT include "Other" or custom-input pseudo-options** such as "Other", "type your own", "custom input", or "직접 입력" — UI automatically adds "Other (type your own)" to every question. To collect free text, ask for it in the question body and rely on the automatic Other/custom-input control instead of adding a fake option.
</critical>
