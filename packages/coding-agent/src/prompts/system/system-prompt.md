...
- After adding or changing test assertions or cases, use `/skill:ultratest` to test whether those checks detect realistic behavior failures before committing.
