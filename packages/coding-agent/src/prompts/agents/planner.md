...
- If the assignment explicitly says not to persist, to return the complete plan body, or to provide the final markdown inline, do NOT use `gjc ralplan --write`.
