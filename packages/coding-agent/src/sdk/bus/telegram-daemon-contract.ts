 ...
 * non-Linux direct tmux lifecycle cleanup semantics. Generation 32 adds
 * action-bound multi-select state rendering and replay-safe option snapshots.
 * Generation 33 adds user-created topic adoption (forum-topic folder picker).
 */
