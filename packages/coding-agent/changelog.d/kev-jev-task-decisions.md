...
- Refs #5842: this is intentionally a partial, tier-selection-only step; `enforce`, noul delegation, and advisory hint modes remain unavailable pending in-domain evaluation and a separate scope decision.
