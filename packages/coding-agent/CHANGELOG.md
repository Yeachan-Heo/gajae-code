...
- Interactive startup now reports missing default model-profile credentials inside the UI instead of hard-exiting before `/login` can be used; non-interactive startup remains fail-closed (#2128).
