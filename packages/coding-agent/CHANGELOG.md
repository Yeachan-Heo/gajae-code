...
- Attached image placeholders such as `[image 1]` are now deleted atomically with Backspace when the cursor is immediately after the placeholder, instead of being erased one character at a time.
