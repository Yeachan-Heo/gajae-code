...
- Managed legacy-session artifact migration now accepts up to 200,000 files, processes copy work in bounded batches, and reports capacity exhaustion separately from unsafe artifact topology (#2935).
