...
- Telegram `/btw` replies now promote supported Markdown tables to native rich-message table blocks by default, with original-Markdown or HTML fallback for unsupported content, delivery failures, and size/structure limits.
