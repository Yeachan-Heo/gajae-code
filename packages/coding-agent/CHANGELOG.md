...
- Hardened the experimental pre-admission artifact spill against unreachable or byte-inexact artifacts, mixed-content reordering, and payloads above the generic 10 MiB artifact cap while preserving that cap for ordinary saves.
