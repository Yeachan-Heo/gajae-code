...
- Reused fresh authoritative model-discovery cache for `gjc --list-models`, avoiding a forced online refresh on every listing while still refreshing when the cache is missing or stale (#2227).
