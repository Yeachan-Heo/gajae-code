...
- OpenAI-compatible web search now reports malformed successful JSON payloads as bounded provider errors instead of leaking raw parse or iteration exceptions.
