...
- Added a Telegram `/menu` button-first command surface for Skills, Model, and Notify actions while redirecting unsafe typed slash commands to guided menu choices.
