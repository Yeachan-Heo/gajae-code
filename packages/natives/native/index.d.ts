 ...
 */
export interface NativeOwnerOnlyWriteDescriptorResult {
  ok: boolean
  code?: string
  fd?: number
}
 ...
 */
export declare function openOwnerOnlyFileForWrite(anchorPath: string, anchorDev: bigint, anchorIno: bigint, fileName: string, append: boolean): NativeOwnerOnlyWriteDescriptorResult
